...
while True:
    ...
    out_img,left,right,center,left_x,_,right_x,_ = draw(bin_img)
    stop_line(bin_img,out_img)
    result_img = cv2.addWeighted(warp_img, 0.6, out_img, 1.0, 0)
